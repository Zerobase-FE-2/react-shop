...
export default function Menu(props: any) {
  return (
    <MenuDiv onClick={() => props.setFunc(!props.func)}>
      <Link to="/fasion">
        <MenuSpan onClick={() => props.setFunc(!props.func)}>패션</MenuSpan>
      </Link>
      <Link to="/accessory">
        <MenuSpan onClick={() => props.setFunc(!props.func)}>악세서리</MenuSpan>
      </Link>
      <Link to="/digital">
        <MenuSpan onClick={() => props.setFunc(!props.func)}>디지털</MenuSpan>
      </Link>
    </MenuDiv>
  );
}
