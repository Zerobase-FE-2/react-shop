...
export default function ProductItemSkeleton() {
  return (
    <div className="m-2 animate-pulse rounded-lg border dark:border-none">
      <div className="flex h-80 items-center justify-center rounded-lg bg-gray-400"></div>
      <div className="flex h-24 flex-col items-start justify-between overflow-auto rounded-b-lg bg-gray-200 p-4 text-black dark:bg-gray-700 dark:text-gray-400">
